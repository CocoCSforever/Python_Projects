def main():
    cough = in_boolean("Are you coughing? ")
 ...
 light hurting your eyes, drowsiness or confusion? ")
    ...
    # we can delete the variable "check_aching" and two "else sections"
    # in if(cough) and elif(headache) above. bc. if main() doesn’t return in
    # previous evaluation, the only left option is to check aching bones.
    if (check_aching):
